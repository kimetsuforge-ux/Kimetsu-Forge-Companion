...
"app_short": "Kimetsu Forge: uma ferramenta de fã, não oficial, que usa o poder do Google Gemini para gerar conteúdo de RPG. Assista Demon Slayer na Crunchyroll.",
"readme_long": `# 🛠️ Kimetsu Forge (Forja de Lendas)

### Forje lendas. Crie universos.
Kimetsu Forge é o seu arsenal criativo para RPGs de mesa, inspirado no universo de Demon Slayer. Use o poder do Google Gemini para gerar itens, inimigos, técnicas e prompts de imagem épicos em segundos.
...
### 🧠 A Alma da Forja: Google Gemini
A Forja agora opera com um único motor de IA, o Google Gemini, para garantir estabilidade e qualidade. Cada criação passa por um processo interno de 3 etapas em uma única chamada:
1.  **A Faísca:** O Gemini gera o conceito bruto, a ideia inicial.
2.  **A Estrutura:** Expande o conceito com lore, mecânicas de RPG e detalhes visuais.
3.  **O Polimento:** Refina a narrativa para um tom de roleplay forte e otimiza o prompt de imagem.
