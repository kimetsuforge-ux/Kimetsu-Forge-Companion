...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={`bg-bg-card border border-border-color rounded-lg shadow-sm transition-all duration-200 hover:shadow-md hover:border-accent-start/50 ${className}`}
    {...props}
  />
));
